...
\begin{figure}[ht]
\begin{center}
    \includegraphics[width=\linewidth]{postavitev.png}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=.9\linewidth]{abs.pdf}
...
Omenjeno, sem nato prikazal na grafu in naredil linearni regresijo, ki nam da razmerje med $B_0$ in $\nu$

\begin{figure}[H]
  \centering
  \includegraphics[width=.9\linewidth]{b0.pdf}
